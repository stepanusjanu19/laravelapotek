...
@section('content')
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<a class="btn btn-primary" role="button" data-toggle="collapse" href="#collapse-tambah" aria-expanded="false" aria-controls="collapseExample">
		  <i class="fa fa-plus"></i> Tambah Data Apoteker
		</a>
		<div class="collapse" id="collapse-tambah">
		  <div class="well">
		    	<div class="x_panel">
		    		<div class="x_title">
		    			<h2>Tambah Data Apoteker</h2>
		    			...
		    			<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
		    				<div class="col-lg-12">
		    					<div class="form-group">
			    					...
			    					<input type="hidden" name="level"  value="apoteker">
              	...
              	<div class="modal-dialog">
              		<div class="modal-content">
              			...
              			<div class="modal-body">
              				<form action="{{ route('updateAdminApoteker') }}" method="post" id="frm-edit">
              				{{ csrf_field() }}
		    				<div class="col-lg-6">
		    					<div class="form-group">
			    					<label>ID</label>
...
@section('customJs')
	<script type="text/javascript">
		$(document).ready(function() {
			...
			// 	// console.log(data);
			// 	$.post("{{ route('updateAdminApoteker') }}", data, function(data) {
			...
			$('#myTable').on('click','.btn-delete', function(e) {
				...
				$.confirm({
			                    ...
			                    buttons: {
			                        confirm: function () {
						$.get("{{route('deleteAdminApoteker')}}", {id:id}, function(data) {
